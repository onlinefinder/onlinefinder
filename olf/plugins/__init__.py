...
""".. sidebar:: Further reading ..
   ...
   - :ref:`plugins admin`
   - :ref:`OnlineFinder settings <settings plugins>`

Plugins can extend or replace functionality of various components of OnlineFinder.
...
built-in plugins :origin:`olf/plugins/` or `Only show green hosted results`_.

.. _Only show green hosted results:
   https://github.com/return42/tgwf-olf-plugins/
...
.. code:: python
   ...
   from olf.plugins import Plugin
...
.. sidebar:: Further reading ..
   ...
   - :py:obj:`Result.filter_urls(..) <olf.result_types._base.Result.filter_urls>`

The :py:obj:`Result.filter_urls(..) <olf.result_types._base.Result.filter_urls>`
...
def initialize(app):
    STORAGE.load_settings(olf.get_setting("plugins"))
    STORAGE.init(app)
