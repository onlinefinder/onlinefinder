...
the ``settings.yml`` file is already located (``/etc/onlinefinder``). The file then
...
from olf.result_types._base import MainResult, LegacyResult
from olf.settings_loader import get_yaml_cfg
...
if t.TYPE_CHECKING:
    ...
    from olf.result_types import Result
