...
def raise_for_httperror(resp: "SXNG_Response") -> None:
    ...
    Raises:
        ...
        olf.exceptions.SearxEngineAccessDeniedException: raise when the HTTP status code is 402 or 403.
        olf.exceptions.SearxEngineTooManyRequestsException: raise when the HTTP status code is 429.
        olf.exceptions.SearxEngineCaptchaException: raise when if CATPCHA challenge is detected.
    """
