...
OnlineFinder permet de modifier les catégories de recherche, les moteurs
...
OnlineFinder supporte les recherches [DuckDuckGo] de type "!Bang". Utilisez
...
sur le moteur externe. Dans ce cas, OnlineFinder ne peut pas protéger votre
vie privée.
...
dangereux. Dans ce cas, OnlineFinder ne peut pas protéger votre vie
