# نحو جستجو
OnlineFinder با یک متن جستجو همراه است که می توانید دسته ها را تغییر دهید،
...
OnlineFinder از ضربه های خارجی پشتیبانی می کند [DuckDuckGo] .  To مستقیماً به a
...
موتور، OnlineFinder نمی تواند از حریم خصوصی شما در این مورد محافظت کند.
