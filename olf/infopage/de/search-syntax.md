...
OnlineFinder verfügt über eine Syntax mit der in einer Suchanfrage die Kategorien,
...
OnlineFinder unterstützt die _external bangs_ von [DuckDuckGo].  Das Präfix `!!` kann
...
OnlineFinder kann die Privatsphäre des Benutzers in diesem Fall nur eingeschränkt
...
Vertrauenswürdigkeit überprüft werden.  OnlineFinder kann die Privatsphäre des
