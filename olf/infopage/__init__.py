...
"""Render OnlineFinder instance documentation.
...
logger = logging.getLogger('olf.infopage')
...
class InfoPageSet:  # pylint: disable=too-few-public-methods
    """Cached rendering of the online documentation a OnlineFinder instance has.
