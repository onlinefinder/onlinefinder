...
from olf.openmetrics import OpenMetricsFamily
...
def openmetrics(engine_stats, engine_reliabilities):
    metrics = [
        OpenMetricsFamily(
            key="onlinefinder_engines_response_time_total_seconds",
            type_hint="gauge",
        ...
        OpenMetricsFamily(
            key="onlinefinder_engines_response_time_processing_seconds",
            type_hint="gauge",
        ...
        OpenMetricsFamily(
            key="onlinefinder_engines_response_time_http_seconds",
            type_hint="gauge",
        ...
        OpenMetricsFamily(
            key="onlinefinder_engines_result_count_total",
            type_hint="counter",
        ...
        OpenMetricsFamily(
            key="onlinefinder_engines_request_count_total",
            type_hint="counter",
        ...
        OpenMetricsFamily(
            key="onlinefinder_engines_reliability_total",
            type_hint="counter",
