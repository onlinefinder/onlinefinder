...
the :origin:`answers.html <olf/templates/simple/elements/answers.html>`
template.
...
class Translations(BaseAnswer, kw_only=True):
    ...
    <olf/templates/simple/answer/translations.html>`"""
...
class WeatherAnswer(BaseAnswer, kw_only=True):
    ...
    <olf/templates/simple/answer/weather.html>`"""
