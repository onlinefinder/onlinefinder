...
class MainResult(Result):  # pylint: disable=missing-class-docstring
    ...
    <olf/templates/simple/result_templates/default.html>` is used.
    """
...
class LegacyResult(dict[str, t.Any]):
    """A wrapper around a legacy result item.  The OnlineFinder core uses this class
    ...
    :py:obj:`olf.results.ResultContainer`.
    ...
    def __init__(self, *args: t.Any, **kwargs: t.Any):
        ...
        if "answer" in self:
            warnings.warn(
                ...
                f" / use a class from olf.result_types.answer",
                DeprecationWarning,
            )
        ...
        if self.template == "keyvalue.html":
            warnings.warn(
                ...
                f" / use a class from olf.result_types",
                DeprecationWarning,
            )
