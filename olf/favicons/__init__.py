...
"""Implementations for providing the favicons in OnlineFinder.
...
an example in which the command line is called in the development environment::
  ...
  (py3) python -m olf.favicons --help
"""
...
def init():
    ...
    cfg_file = (settings_loader.get_user_cfg_folder() or pathlib.Path("/etc/onlinefinder")) / "favicons.toml"
