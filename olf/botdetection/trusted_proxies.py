...
class ProxyFix:
    ...
    .. sidebar:: :py:obj:`flask.Request.remote_addr`
       ...
       OnlineFinder uses Werkzeug's ProxyFix_ (with it default ``x_for=1``).
    ...
    - `X-Real-IP <https://github.com/onlinefinder/onlinefinder/issues/1237#issuecomment-1147564516>`__:
