...
from olf.network import get, raise_for_httperror  # see https://github.com/onlinefinder/onlinefinder/issues/762
from olf.utils import html_to_text
...
OnlineFinder needs in the response to build a video result list.
"""
...
"""URL template to embed video in OnlineFinder's result list."""
...
def request(query, params):
    ...
    eng_region: str = traits.get_region(params['onlinefinder_locale'], 'en_US')  # type: ignore
    eng_lang = traits.get_language(params['onlinefinder_locale'], 'en')
    ...
    if len(params['onlinefinder_locale'].split('-')) > 1:
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    .. _PR1071: https://github.com/onlinefinder/onlinefinder/pull/1071
