...
If you want to use invidious with OnlineFinder you should setup one locally.
No public instance offer a public API now

- https://github.com/onlinefinder/onlinefinder/issues/2722#issuecomment-2884993248
