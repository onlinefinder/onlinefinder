...
from olf.utils import extract_text, eval_xpath, eval_xpath_list, eval_xpath_getindex
from olf.locales import language_tag, region_tag, get_official_locales
...
if t.TYPE_CHECKING:
    ...
    from olf.search.processors import OnlineParams
...
.. _Google max 50 pages: https://github.com/onlinefinder/onlinefinder/issues/2982
"""
...
def get_google_info(params: "OnlineParams", eng_traits: EngineTraits) -> dict[str, t.Any]:
    ...
    :param dict param: Request parameters of the engine.  At least
        a ``onlinefinder_locale`` key should be in the dictionary.

    :param eng_traits: Engine's traits fetched from google preferences
        (:py:obj:`olf.enginelib.traits.EngineTraits`)
    ...
    sxng_locale = params.get('onlinefinder_locale', 'all')
    try:
    ...
    # https://github.com/onlinefinder/onlinefinder/issues/2515#issuecomment-1607150817
    ...
    # locale --> https://github.com/onlinefinder/onlinefinder/issues/2672
    ret_val['params']['cr'] = ''
    ...
    # https://github.com/onlinefinder/onlinefinder/issues/2515#issuecomment-1606294635
    ...
    # - https://github.com/onlinefinder/onlinefinder/pull/1679#issuecomment-1235432746
    # - https://github.com/onlinefinder/onlinefinder/issues/1555
