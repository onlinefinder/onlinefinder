...
from olf.utils import onlinefinder_useragent
...
def request(query, params):
    ...
    params['headers'] = {
        ...
        'User-Agent': onlinefinder_useragent(),
    }
    region = traits.get_region(params["onlinefinder_locale"], default=traits.all_locale)
    params['data'] = dumps(
        {
            'query': query,
