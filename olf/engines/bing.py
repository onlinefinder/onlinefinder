...
in OnlineFinder to get the translations of data such as *"published last week"*.
...
from olf.utils import eval_xpath, extract_text, eval_xpath_list, eval_xpath_getindex
from olf.locales import language_tag, region_tag
from olf.enginelib.traits import EngineTraits
from olf.exceptions import SearxEngineAPIException
...
verification by a cookie is needed / thats not possible in OnlineFinder.
"""
...
def request(query, params):
    ...
    engine_region = traits.get_region(params['onlinefinder_locale'], traits.all_locale)  # type: ignore
    engine_language = traits.get_language(params['onlinefinder_locale'], 'en')  # type: ignore
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from olf.utils import gen_useragent
