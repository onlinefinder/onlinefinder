...
and unpack into ``olf/data/filmliste-v2.db``.  To search the database use e.g
...
.. code:: yaml
  ...
  - name: mediathekview
    ...
    database: olf/data/filmliste-v2.db
    query_str: >-
...
from olf.result_types import MainResult, KeyValue
