...
if t.TYPE_CHECKING:
    from olf.search.processors import RequestParams
...
def setup(engine_settings: dict[str, t.Any]) -> bool:
    ...
    For more details see :py:obj:`olf.enginelib.Engine.setup`.
    """
...
def init(engine_settings: dict[str, t.Any]) -> bool:  # pylint: disable=unused-argument
    ...
    For more details see :py:obj:`olf.enginelib.Engine.init`.
    """
    return True
...
def search(query: str, params: "RequestParams") -> EngineResults:
    ...
    for row in data_rows:
        ...
        kvmap = {
            'query': query,
            'language': params['onlinefinder_locale'],
            'value': row.get("value"),
        }
        res.add(
            res.types.KeyValue(
