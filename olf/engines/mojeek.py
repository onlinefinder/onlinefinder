...
from olf.utils import eval_xpath, eval_xpath_list, extract_text
...
def request(query, params):
    args = {
        ...
        language_param: traits.get_language(params['onlinefinder_locale'], traits.custom['language_all']),
        region_param: traits.get_region(params['onlinefinder_locale'], traits.custom['region_all']),
    }
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from olf.locales import get_official_locales, region_tag
