...
authentication.  What this means is that by default, OnlineFinder will have no way to
...
"""Optional, if true OnlineFinder will link directly to the mp4 of the video to play
