...
""".. sidebar:: info
   ...
   - :origin:`elasticsearch.py <olf/engines/elasticsearch.py>`
...
def _match_query(query):
    ...
    OnlineFinder format: "key:value" e.g. city:berlin
...
def _term_query(query):
    ...
    olf format: "key:value" e.g. city:berlin
...
def _terms_query(query):
    ...
    olf format: "key:value1,value2" e.g. city:berlin,paris
