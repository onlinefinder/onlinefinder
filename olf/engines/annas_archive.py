...
With this options a OnlineFinder maintainer is able to configure **additional**
...
from olf.utils import extract_text, eval_xpath, eval_xpath_getindex, eval_xpath_list
from olf.enginelib.traits import EngineTraits
from olf.data import ENGINE_TRAITS
from olf.exceptions import SearxEngineXPathException
...
def request(query: str, params: "OnlineParams") -> None:
    lang = traits.get_language(params["onlinefinder_locale"], traits.all_locale)
    args = {
        "lang": lang,
        "content": aa_content,
        "ext": aa_ext,
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from olf.locales import language_tag
