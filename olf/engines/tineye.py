...
.. hint::
   ...
   This OnlineFinder engine only supports *'searching by URL'* and it does not use
...
""":py:obj:`olf.search.processors.online_url_search`"""
    ...
    if resp.status_code in (400, 422):
        ...
        if resp.status_code == 422:
            ...
            if s_key == "Invalid image URL":
                # test https://docs.onlinefinder.org/_static/onlinefinder-wordmark.svg
        ...
        # see https://github.com/onlinefinder/onlinefinder/pull/1456#issuecomment-1193105023
