...
from olf.data import WIKIDATA_UNITS
from olf.network import post, get
from olf.utils import onlinefinder_useragent, get_string_replaces_function
from olf.external_urls import get_external_url, get_earth_coordinates_url, area_to_osm_zoom
from olf.engines.wikipedia import (
...
def get_headers():
    ...
    return {'Accept': 'application/sparql-results+json', 'User-Agent': onlinefinder_useragent()}
...
def request(query, params):
    ...
    eng_tag, _wiki_netloc = get_wiki_params(params['onlinefinder_locale'], traits)
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    <olf.engines.wikipedia.fetch_wikimedia_traits>` and removes
