...
from olf.utils import extract_text, eval_xpath, eval_xpath_list, ElementType
from olf.enginelib.traits import EngineTraits
from olf.data import ENGINE_TRAITS
from olf.exceptions import SearxException
...
def request(query: str, params: "OnlineParams") -> None:
    lang: str | None = traits.get_language(params["onlinefinder_locale"], traits.all_locale)
    search_url: str = (
        base_url
