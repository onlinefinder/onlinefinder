...
from olf.exceptions import SearxEngineCaptchaException, SearxEngineAccessDeniedException

from olf.engines.google import fetch_traits  # pylint: disable=unused-import
from olf.engines.google import (
    get_google_info,
    time_range_dict,
)
...
def time_range_args(params: "OnlineParams") -> dict[str, int]:
    ...
    month* or *last week* (as offered by OnlineFinder) is uncommon for scientific
    publications and is not supported by Google Scholar.

    To limit the result list when the users selects a range, all the OnlineFinder
