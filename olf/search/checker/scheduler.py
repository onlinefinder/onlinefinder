...
* the Valkey key OnlineFinder_checker_next_call_ts contains the next time the embedded checker should run.
* to avoid lock, a unique Valkey script reads and updates the Valkey key OnlineFinder_checker_next_call_ts.
...
from olf.valkeylib import lua_script_storage


logger = logging.getLogger('olf.search.checker')
