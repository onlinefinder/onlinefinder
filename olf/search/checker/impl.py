...
from olf import network, logger
...
from olf.search.processors import EngineProcessor
from olf.metrics import counter_inc


logger = logger.getChild('olf.search.checker')
