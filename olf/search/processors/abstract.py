...
from olf.engines import engines
from olf.network import get_time_for_thread, get_network
from olf.metrics import histogram_observe, counter_inc, count_exception, count_error
from olf.exceptions import SearxEngineAccessDeniedException
from olf.utils import get_engine_from_settings

if t.TYPE_CHECKING:
    import types
    from olf.enginelib import Engine
    from olf.search.models import SearchQuery
    from olf.results import ResultContainer
    from olf.result_types import Result, LegacyResult  # pyright: ignore[reportPrivateLocalImportUsage]


logger = logger.getChild("olf.search.processor")
...
class EngineProcessor(ABC):
    ...
    def get_params(self, search_query: "SearchQuery", engine_category: str) -> RequestParams | None:
        ...
        params: RequestParams = {
            ...
            "onlinefinder_locale": search_query.lang,
        }

        # deprecated / vintage --> use params["onlinefinder_locale"]
        #
