...
from olf import logger, get_setting
...
if TYPE_CHECKING:
    ...
    from olf.search import SearchQuery
    from olf.results import UnresponsiveEngine
...
exception_classname_to_text = {
    ...
    'olf.exceptions.SearxEngineCaptchaException': gettext("CAPTCHA"),
    'olf.exceptions.SearxEngineTooManyRequestsException': gettext("too many requests"),
    'olf.exceptions.SearxEngineAccessDeniedException': gettext("access denied"),
    'olf.exceptions.SearxEngineAPIException': gettext("server API error"),
    'olf.exceptions.SearxEngineXPathException': parsing_error_text,
...
def onlinefinder_l10n_timespan(dt: datetime) -> str:  # pylint: disable=invalid-name
