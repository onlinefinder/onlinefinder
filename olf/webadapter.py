...
from olf.engines import categories, engines
from olf.search.models import SearchQuery, EngineRef
from olf.preferences import Preferences, is_locked
from olf.utils import detect_language
...
def get_search_query_from_webapp(
    ...
    1. instance of :py:obj:`olf.search.SearchQuery`
    2. instance of :py:obj:`olf.query.RawTextQuery`
    3. list of :py:obj:`olf.search.EngineRef` instances
    ...
    <olf.utils.detect_language>`.  If language recognition does not have a
