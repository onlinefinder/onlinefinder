...
import olf.webapp
import olf.search
import olf.search.processors
from olf.result_types._base import MainResult

from olf.results import Timing
from olf.preferences import Preferences
...
class ViewsTestCase(SearxTestCase):  # pylint: disable=too-many-public-methods
    ...
    def setUp(self):
        ...
        self.setattr4test(olf.search.processors.PROCESSORS, 'init', dummy)
        ...
        self.setattr4test(olf.search.Search, 'search', search_mock)
    ...
    def test_index_empty(self):
        ...
        self.assertIn(
            b'<div class="title"><h1>OnlineFinder</h1></div>',
            result.data,
        )
    ...
    def test_search_empty_html(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'<div class="title"><h1>OnlineFinder</h1></div>', result.data)
    ...
    def test_search_rss(self):
        ...
        self.assertIn(b'<description>Search results for "test" - OnlineFinder</description>', result.data)
    ...
    def test_opensearch_xml(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(
            b'<Description>OnlineFinder is a metasearch engine that respects your privacy.</Description>', result.data
        )
