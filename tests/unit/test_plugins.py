...
plg_store = olf.plugins.PluginStorage()
plg_store.load_settings(olf.get_setting("plugins"))
...
def get_search_mock(query, **kwargs):
    ...
    return Mock(
        ...
        result_container=olf.results.ResultContainer(),
    )
...
class PluginMock(olf.plugins.Plugin):

    def __init__(self, _id: str, name: str, active: bool):
        plg_cfg = olf.plugins.PluginCfg(active=active)
        self.id = _id
        self._name = name
