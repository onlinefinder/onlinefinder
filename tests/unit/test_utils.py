...
class TestUtils(SearxTestCase):
    ...
    def test_onlinefinder_useragent(self):
        self.assertIsInstance(utils.onlinefinder_useragent(), str)
        self.assertIsNotNone(utils.onlinefinder_useragent())
        self.assertTrue(utils.onlinefinder_useragent().startswith('OnlineFinder'))
