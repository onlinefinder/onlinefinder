...
from olf.search.models import EngineRef
from olf.webadapter import validate_engineref_list
...
class ValidateQueryCase(SearxTestCase):
    ...
    def test_without_token(self):
        preferences = Preferences(['simple'], ['general'], engines, olf.plugins.STORAGE)
    ...
    def test_with_incorrect_token(self):
        preferences_with_tokens = Preferences(['simple'], ['general'], engines, olf.plugins.STORAGE)
