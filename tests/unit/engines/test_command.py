...
from olf.engines import command as command_engine
from olf.result_types import KeyValue
...
class TestCommandEngine(SearxTestCase):
    ...
    def test_delimiter_parsing(self):
        searx_logs = '''DEBUG:olf.webapp:static directory is /home/n/p/olf/olf/static
DEBUG:olf.webapp:templates directory is /home/n/p/olf/olf/templates
DEBUG:olf.engines:soundcloud engine: Starting background initialization
DEBUG:olf.engines:wolframalpha engine: Starting background initialization
DEBUG:olf.engines:locate engine: Starting background initialization
DEBUG:olf.engines:regex search in files engine: Starting background initialization
...
DEBUG:olf.engines:find engine: Starting background initialization
DEBUG:olf.engines:pattern search in files engine: Starting background initialization
DEBUG:olf.webapp:starting webserver on 127.0.0.1:8888
...
INFO:werkzeug: * Debugger PIN: 299-578-362'''
        ...
        page1 = [
            {
                'component': 'olf.webapp',
                'message': 'static directory is /home/n/p/olf/olf/static',
                'level': 'DEBUG',
            },
            {
                'component': 'olf.webapp',
                'message': 'templates directory is /home/n/p/olf/olf/templates',
                'level': 'DEBUG',
            },
            {
                'component': 'olf.engines',
