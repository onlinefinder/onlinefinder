...
class SearxRobotLayer:
    ...
    def setUp(self):
        ...
        # get program paths
        webapp = str(tests_path.parent / 'olf' / 'webapp.py')
        exe = 'python'

        # set robot settings path
        os.environ['ONLINEFINDER_SETTINGS_PATH'] = str(tests_path / 'robot' / 'settings_robot.yml')
    ...
    def tearDown(self):
        ...
        del os.environ['ONLINEFINDER_SETTINGS_PATH']
