...
.. _Quickstart guide: https://docs.onlinefinder.org/dev/quickstart.html
.. _Commits guide: https://docs.onlinefinder.org/dev/commits.html
.. _Weblate: https://translate.codeberg.org/projects/onlinefinder/onlinefinder/
.. _GitHub Codespaces: https://docs.github.com/en/codespaces/overview
.. _120 hours per month: https://github.com/settings/billing
.. _list of existing Codespaces: https://github.com/codespaces

Thank you for your interest in OnlineFinder.

Have a look at our `Quickstart guide`_, it's very easy to contribute.

Further information on *how-to* can be found
`here <https://docs.onlinefinder.org/dev/index.html>`_.

Translations
============

Help translate OnlineFinder at `Weblate`_.

.. image:: https://translate.codeberg.org/widget/onlinefinder/onlinefinder/horizontal-auto.svg
   :target: https://translate.codeberg.org/engage/onlinefinder/
   :alt: Weblate
   :width: 768px
...
- You can start OnlineFinder using ``make run`` in the terminal or by pressing ``Ctrl+Shift+B``.
...
not your character or personality. Keep in mind we all want to make OnlineFinder
better.
