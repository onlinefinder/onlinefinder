...
*developer install* of OnlineFinder (:origin:`setup.py`). ::

   $ cd ~/onlinefinder-clone
   $ make install
   PYENV     [virtualenv] installing ./requirements*.txt into local/py3
   ...
   PYENV     [install] pip install --use-pep517 --no-build-isolation -e 'searx[test]'
   ...
   Successfully installed onlinefinder-2023.7.19+a446dea1b
...
.. tabs::
  ...
  .. group-tab:: nvm.install
     ...
     .. code:: sh
        ...
        INFO:  install (update) NVM at ./onlinefinder/.nvm
        INFO:  clone: https://github.com/nvm-sh/nvm.git
          || Cloning into './onlinefinder/.nvm'...
...
Install latest Node.js_ locally (uses nvm_)::
  ...
  $ make nvm.nodejs
  INFO:  install (update) NVM at /share/onlinefinder/.nvm
  INFO:  clone: https://github.com/nvm-sh/nvm.git
  ...
  Downloading and installing node v16.13.0...
  ...
  INFO:  Node.js is installed at onlinefinder/.nvm/versions/node/v16.13.0/bin/node
  INFO:  Node.js is version v16.13.0
  INFO:  npm is installed at onlinefinder/.nvm/versions/node/v16.13.0/bin/npm
  INFO:  npm is version 8.1.0
  INFO:  NVM is installed at onlinefinder/.nvm
...
*debug* option in :origin:`searx/settings.yml`, starts a ``./olf/webapp.py``
...
Python programming language.  The pylint profile used in the OnlineFinder project is
...
To see HTTP requests and more use ONLINEFINDER_DEBUG::

    make ONLINEFINDER_DEBUG=1 search.checker.google_news

.. _3xx: https://en.wikipedia.org/wiki/List_of_HTTP_status_codes#3xx_redirection

To filter out HTTP redirects (3xx_)::

    make ONLINEFINDER_DEBUG=1 search.checker.google_news | grep -A1 "HTTP/1.1\" 3[0-9][0-9]"
    ...
