...
.. sidebar:: KISS_ and readability_
   ...
   Instead of defining more and more roles, we at OnlineFinder encourage our
   contributors to follow principles like KISS_ and readability_.

We at OnlineFinder are using reStructuredText (aka reST_) markup for all kind of
documentation.  With the builders from the Sphinx_ project a HTML output is
generated and deployed at docs.onlinefinder.org_.  For build prerequisites read
:ref:`docs build`.

.. _docs.onlinefinder.org: https://docs.onlinefinder.org/

The source files of OnlineFinder's documentation are located at :origin:`docs`.
...
Admin's POV: :origin:`docs/admin`
  ...
  not know all the pros and cons of a OnlineFinder setup.
...
.. code:: sh
   ...
   ...
   $ python -m sphinx.ext.intersphinx https://docs.onlinefinder.org/objects.inv
   ...
...
OnlineFinder's sphinx setup includes: :ref:`linuxdoc:kfigure`.  Scalable here means;
...
install` (with OnlineFinder modules installed).  We use this e.g. to build chapter:
