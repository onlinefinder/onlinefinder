...
.. _translate.codeberg.org: https://translate.codeberg.org/projects/onlinefinder/
.. _Weblate: https://docs.weblate.org
.. _translations branch: https://github.com/onlinefinder/onlinefinder/tree/translations
.. _orphan branch: https://git-scm.com/docs/git-checkout#Documentation/git-checkout.txt---orphanltnewbranchgt
.. _Weblate repository: https://translate.codeberg.org/projects/onlinefinder/onlinefinder/#repository
.. _wlc: https://docs.weblate.org/en/latest/wlc.html

.. |translated| image:: https://translate.codeberg.org/widgets/onlinefinder/-/onlinefinder/svg-badge.svg
...
.. sidebar:: |translated|
   ...
   - Weblate_
   - OnlineFinder `translations branch`_
   - OnlineFinder `Weblate repository`_
   - Weblate Client: wlc_
...
committed to Weblate's counterpart of the OnlineFinder *origin* repository which is
located at ``https://translate.codeberg.org/git/onlinefinder/onlinefinder``.

There is no need to clone this repository, :ref:`OnlineFinder Weblate workflow` take
care of the synchronization with the *origin*.  To avoid merging commits from
the counterpart directly on the ``master`` branch of *OnlineFinder origin*, a *pull
...
.. _OnlineFinder Weblate workflow:

.. figure:: translation.svg

   OnlineFinder's PR workflow to be in sync with Weblate

Sync from *origin* to *weblate*: using ``make weblate.push.translations``
  For each commit on the ``master`` branch of OnlineFinder *origin* the GitHub job
