...
With the *SQL engines* you can bind SQL databases into OnlineFinder.  The following
...
install additional packages in Python's Virtual Environment of your OnlineFinder
instance.  To switch into the environment (:ref:`onlinefinder-src`) you can use
:ref:`onlinefinder.sh`::
