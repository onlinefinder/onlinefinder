...
.. note::
   ...
   Granian will be the future replacement for :ref:`onlinefinder uwsgi` in OnlineFinder.
...
the following command in the Python environment of the OnlineFinder installation:
