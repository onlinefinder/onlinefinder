...
build hosts (see :ref:`onlinefinder.sh`).

.. _onlinefinder.sh install buildhost:
...
.. tabs::
  ...
  .. group-tab:: OnlineFinder's development tools

     .. code:: sh

        $ sudo -H ./utils/onlinefinder.sh install buildhost

This will install packages needed by OnlineFinder:
...
output (:ref:`install buildhost <onlinefinder.sh install buildhost>`).
...
(:ref:`install buildhost <onlinefinder.sh install buildhost>`).
