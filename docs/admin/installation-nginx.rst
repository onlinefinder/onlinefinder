...
This section explains how to set up a OnlineFinder instance using the HTTP server nginx_.
If you have used the :ref:`installation scripts` and do not have any special preferences
you can install the :ref:`OnlineFinder site <nginx onlinefinder site>` using
:ref:`onlinefinder.sh <onlinefinder.sh overview>`:

.. code:: bash

   $ sudo -H ./utils/onlinefinder.sh install nginx
...
.. _nginx onlinefinder site:

NGINX's OnlineFinder site
====================

Now you have to create a configuration file (``onlinefinder.conf``) for the OnlineFinder
...
Depending on what your OnlineFinder installation is listening on, you need a http or socket
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. code:: bash
         ...
         sudo -H ln -s /etc/nginx/sites-available/onlinefinder.conf \
                       /etc/nginx/sites-enabled/onlinefinder.conf
   ...
   .. group-tab:: Arch Linux
      ...
      .. code:: bash
         ...
         sudo -H ln -s /etc/nginx/default.apps-available/onlinefinder.conf \
                       /etc/nginx/default.d/onlinefinder.conf
   ...
   .. group-tab::  Fedora / RHEL
      ...
      .. code:: bash
         ...
         sudo -H ln -s /etc/nginx/default.apps-available/onlinefinder.conf \
                       /etc/nginx/conf.d/onlinefinder.conf
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. code:: bash
         ...
         sudo -H service uwsgi restart onlinefinder
   ...
   .. group-tab:: Arch Linux
      ...
      .. code:: bash
         ...
         sudo -H systemctl restart nginx
         sudo -H systemctl restart uwsgi@onlinefinder
   ...
   .. group-tab:: Fedora / RHEL
      ...
      .. code:: bash
         ...
         sudo -H systemctl restart nginx
         sudo -H touch /etc/uwsgi.d/onlinefinder.ini
