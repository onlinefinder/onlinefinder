...
``timeout`` : optional
  ...
  modify the global timeout of OnlineFinder.**
...
OnlineFinder does not support true multilingual search.  You have to use the language
...
language, OnlineFinder will search in your default and other language.
