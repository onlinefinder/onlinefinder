...
``default_locale`` :
  OnlineFinder interface language.  If blank, the locale is detected by using the
  browser language.  If it doesn't work, or you are deploying a language
  specific instance of OnlineFinder, a locale can be defined using an ISO language
  code, like ``fr``, ``en``, ``de``.
...
``default_theme`` :
  Name of the theme you want to use by default on your OnlineFinder instance.
