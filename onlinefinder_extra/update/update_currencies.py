...
"""Fetch currencies from :origin:`olf/engines/wikidata.py` engine.

Output file: :origin:`olf/data/currencies.json` (:origin:`CI Update data ...
...
from olf.locales import LOCALE_NAMES, locales_initialize
from olf.engines import wikidata, set_loggers
from olf.data.currencies import CurrenciesDB
...
def main():
    ...
    # olf.search.processors.online_currency.name_to_iso4217
