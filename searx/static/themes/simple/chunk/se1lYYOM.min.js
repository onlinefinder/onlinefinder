...
`&&t>0},b.isDecimalMark=function(e,t){return e===`.`&&t!==`/`&&t!==`*`&&t!==`^`},b.isDigitDot=function(e){return e>=`0`&&e<=`9`||e===`.`},b.isDigit=function(e){return e>=`0`&&e<=`9`};function ae(e,t){var n=re();d(n,{expression:e,extraNodes:t}),A(n);var r=oe(n);if(n.token!==``)throw n.tokenType===S.DELIMITER?Le(n,`Unexpected operator `+n.token):U(n,`Unexpected part "`+n.token+`"`);return r}function oe(e){var t,n=[],r;for(e.token!==``&&e.token!==`
`&&e.token!==`;`&&(t=N(e),e.comment&&(t.comment=e.comment));e.token===`
`||e.token===`;`;)n.length===0&&t&&(r=e.token!==`;`,n.push({node:t,visible:r})),A(e),e.token!==`
`&&e.token!==`;`&&e.token!==``&&(t=N(e),e.comment&&(t.comment=e.comment),r=e.token!==`;`,n.push({node:t,visible:r}));return n.length>0?new s(n):(t||(t=new l(void 0),e.comment&&(t.comment=e.comment)),t)}function N(e){var t,n,r,i,a=se(e);if(e.token===`=`){if(V(a))return t=a.name,j(e),r=N(e),new o(new y(t),r);if(L(a)){if(a.optionalChaining)throw U(e,`Cannot assign to optional chain`);return j(e),r=N(e),new o(a.object,a.index,r)}else if(xe(a)&&V(a.fn)&&(i=!0,n=[],t=a.name,a.args.forEach(function(e,t){V(e)?n[t]=e.name:i=!1}),i))return j(e),r=N(e),new u(t,n,r);throw U(e,`Invalid left hand side of assignment operator =`)}return a}function se(e){for(var t=ce(e);e.token===`?`;){var n=e.conditionalLevel;e.conditionalLevel=e.nestingLevel,j(e);var r=t,i=N(e);if(e.token!==`:`)throw U(e,`False part of conditional expression expected`);e.conditionalLevel=null,j(e),t=new c(r,i,N(e)),e.conditionalLevel=n}return t}function ce(e){for(var t=le(e);e.token===`or`;)j(e),t=new h(`or`,`or`,[t,le(e)]);return t}function le(e){for(var t=ue(e);e.token===`xor`;)j(e),t=new h(`xor`,`xor`,[t,ue(e)]);return t}function ue(e){for(var t=de(e);e.token===`and`;)j(e),t=new h(`and`,`and`,[t,de(e)]);return t}function de(e){for(var t=P(e);e.token===`|`;)j(e),t=new h(`|`,`bitOr`,[t,P(e)]);return t}function P(e){for(var t=F(e);e.token===`^|`;)j(e),t=new h(`^|`,`bitXor`,[t,F(e)]);return t}function F(e){for(var t=fe(e);e.token===`&`;)j(e),t=new h(`&`,`bitAnd`,[t,fe(e)]);return t}function fe(e){for(var t=[pe(e)],n=[],r={"==":`equal`,"!=":`unequal`,"<":`smaller`,">":`larger`,"<=":`smallerEq`,">=":`largerEq`};H(r,e.token);){var i={name:e.token,fn:r[e.token]};n.push(i),j(e),t.push(pe(e))}return t.length===1?t[0]:t.length===2?new h(n[0].name,n[0].fn,t):new v(n.map(e=>e.fn),t)}function pe(e){for(var t=I(e),n,r,i,a={"<<":`leftShift`,">>":`rightArithShift`,">>>":`rightLogShift`};H(a,e.token);)n=e.token,r=a[n],j(e),i=[t,I(e)],t=new h(n,r,i);return t}function I(e){for(var t=me(e),n,r,i,a={to:`to`,in:`to`};H(a,e.token);)n=e.token,r=a[n],j(e),n===`in`&&`])},;`.includes(e.token)?t=new h(`*`,`multiply`,[t,new y(`in`)],!0):(i=[t,me(e)],t=new h(n,r,i));return t}function me(e){var t,n=[];if(t=e.token===`:`?new l(1):he(e),e.token===`:`&&e.conditionalLevel!==e.nestingLevel){for(n.push(t);e.token===`:`&&n.length<3;)j(e),e.token===`)`||e.token===`]`||e.token===`,`||e.token===``?n.push(new y(`end`)):n.push(he(e));t=n.length===3?new _(n[0],n[2],n[1]):new _(n[0],n[1])}return t}function he(e){for(var t=ge(e),n,r,i,a={"+":`add`,"-":`subtract`};H(a,e.token);){n=e.token,r=a[n],j(e);var o=ge(e);i=o.isPercentage?[t,new h(`*`,`multiply`,[t,o])]:[t,o],t=new h(n,r,i)}return t}function ge(e){for(var t=_e(e),n=t,r,i,a={"*":`multiply`,".*":`dotMultiply`,"/":`divide`,"./":`dotDivide`,"%":`mod`,mod:`mod`};H(a,e.token);)r=e.token,i=a[r],j(e),n=_e(e),t=new h(r,i,[t,n]);return t}function _e(e){for(var t=ve(e),n=t;e.tokenType===S.SYMBOL||e.token===`in`&&R(t)||e.token===`in`&&Ce(t)&&t.fn===`unaryMinus`&&R(t.args[0])||e.tokenType===S.NUMBER&&!R(n)&&(!Ce(n)||n.op===`!`)||e.token===`(`;)n=ve(e),t=new h(`*`,`multiply`,[t,n],!0);return t}function ve(e){for(var t=be(e),n=t,r=[];e.token===`/`&&ye(n);)if(r.push(d({},e)),j(e),e.tokenType===S.NUMBER)if(r.push(d({},e)),j(e),e.tokenType===S.SYMBOL||e.token===`(`||e.token===`in`)d(e,r.pop()),r.pop(),n=be(e),t=new h(`/`,`divide`,[t,n]);else{r.pop(),d(e,r.pop());break}else{d(e,r.pop());break}return t}function be(e){var t=z(e);if(e.token===`%`){var n=d({},e);j(e);try{z(e),d(e,n)}catch{t=new h(`/`,`divide`,[t,new l(100)],!1,!0)}}return t}function z(e){var t,n,r,i={"-":`unaryMinus`,"+":`unaryPlus`,"~":`bitNot`,not:`not`};return H(i,e.token)?(r=i[e.token],t=e.token,j(e),n=[z(e)],new h(t,r,n)):B(e)}function B(e){var t=Se(e),n,r,i;return(e.token===`^`||e.token===`.^`)&&(n=e.token,r=n===`^`?`pow`:`dotPow`,j(e),i=[t,z(e)],t=new h(n,r,i)),t}function Se(e){for(var t=we(e);e.token===`??`;)j(e),t=new h(`??`,`nullish`,[t,we(e)]);return t}function we(e){for(var t=Te(e),n,r,i,a={"!":`factorial`,"'":`ctranspose`};H(a,e.token);)n=e.token,r=a[n],A(e),i=[t],t=new h(n,r,i),t=De(e,t);return t}function Te(e){var t=[];if(e.tokenType===S.SYMBOL&&H(e.extraNodes,e.token)){var n=e.extraNodes[e.token];if(A(e),e.token===`(`){if(t=[],ie(e),A(e),e.token!==`)`)for(t.push(N(e));e.token===`,`;)A(e),t.push(N(e));if(e.token!==`)`)throw U(e,`Parenthesis ) expected`);M(e),A(e)}return new n(t)}return Ee(e)}function Ee(e){var t,r;return e.tokenType===S.SYMBOL||e.tokenType===S.DELIMITER&&e.token in te?(r=e.token,A(e),t=H(ne,r)?new l(ne[r]):C.includes(r)?new l(n(r,`number`)):new y(r),t=De(e,t),t):Oe(e)}function De(e,t,n){for(var r;;){var a=!1;e.token===`?.`&&(a=!0,A(e));var o=(e.token===`(`||e.token===`[`||e.token===`.`)&&(!n||n.includes(e.token));if(!(a||o))break;if(r=[],e.token===`(`)if(a||V(t)||L(t)){if(ie(e),A(e),e.token!==`)`)for(r.push(N(e));e.token===`,`;)A(e),r.push(N(e));if(e.token!==`)`)throw U(e,`Parenthesis ) expected`);M(e),A(e),t=new f(t,r,a)}else return t;else if(e.token===`[`){if(ie(e),A(e),e.token!==`]`)for(r.push(N(e));e.token===`,`;)A(e),r.push(N(e));if(e.token!==`]`)throw U(e,`Parenthesis ] expected`);M(e),A(e),t=new i(t,new p(r),a)}else{if(a||A(e),!(e.tokenType===S.SYMBOL||e.tokenType===S.DELIMITER&&e.token in te)){var s=`Property name expected after `;throw s+=a?`optional chain`:`dot`,U(e,s)}r.push(new l(e.token)),A(e),t=new i(t,new p(r,!0),a)}}return t}function Oe(e){var t,n;return e.token===`"`||e.token===`'`?(n=ke(e,e.token),t=new l(n),t=De(e,t),t):Ae(e)}function ke(e,t){for(var n=``;E(e)!==``&&E(e)!==t;)if(E(e)===`\\`){D(e);var r=E(e),i=w[r];if(i!==void 0)n+=i,e.index+=1;else if(r===`u`){var a=e.expression.slice(e.index+1,e.index+5);if(/^[0-9A-Fa-f]{4}$/.test(a))n+=String.fromCharCode(parseInt(a,16)),e.index+=5;else throw U(e,`Invalid unicode character \\u${a}`)}else throw U(e,`Bad escape character \\${r}`)}else n+=E(e),D(e);if(A(e),e.token!==t)throw U(e,`End of string ${t} expected`);return A(e),n}function Ae(e){var t,n,r,i;if(e.token===`[`){if(ie(e),A(e),e.token!==`]`){var o=je(e);if(e.token===`;`){for(r=1,n=[o];e.token===`;`;)A(e),e.token!==`]`&&(n[r]=je(e),r++);if(e.token!==`]`)throw U(e,`End of matrix ] expected`);M(e),A(e),i=n[0].items.length;for(var s=1;s<r;s++)if(n[s].items.length!==i)throw Le(e,`Column dimensions mismatch (`+n[s].items.length+` !== `+i+`)`);t=new a(n)}else{if(e.token!==`]`)throw U(e,`End of matrix ] expected`);M(e),A(e),t=o}}else M(e),A(e),t=new a([]);return De(e,t)}return Me(e)}function je(e){for(var t=[N(e)],n=1;e.token===`,`;)A(e),e.token!==`]`&&e.token!==`;`&&(t[n]=N(e),n++);return new a(t)}function Me(e){if(e.token===`{`){ie(e);var t,n={};do if(A(e),e.token!==`}`){if(e.token===`"`||e.token===`'`)t=ke(e,e.token);else if(e.tokenType===S.SYMBOL||e.tokenType===S.DELIMITER&&e.token in te)t=e.token,A(e);else throw U(e,`Symbol or string expected as object key`);if(e.token!==`:`)throw U(e,`Colon : expected after object key`);A(e),n[t]=N(e)}while(e.token===`,`);if(e.token!==`}`)throw U(e,`Comma , or bracket } expected after object value`);M(e),A(e);var r=new m(n);return r=De(e,r),r}return Ne(e)}function Ne(e){var t;if(e.tokenType===S.NUMBER){t=e.token,A(e);var i=Ve(t,r);return new l(n(t,i))}return Pe(e)}function Pe(e){var t;if(e.token===`(`){if(ie(e),A(e),t=N(e),e.token!==`)`)throw U(e,`Parenthesis ) expected`);return M(e),A(e),t=new g(t),t=De(e,t),t}return Fe(e)}function Fe(e){throw e.token===``?U(e,`Unexpected end of expression`):U(e,`Value expected`)}function Ie(e){return e.index-e.token.length+1}function U(e,t){var n=Ie(e),r=SyntaxError(t+` (char `+n+`)`);return r.char=n,r}function Le(e,t){var n=Ie(e),r=SyntaxError(t+` (char `+n+`)`);return r.char=n,r}return t.addConversion({from:`string`,to:`Node`,convert:b}),b}),Rr=`evaluate`,zr=K(Rr,[`typed`,`parse`],e=>{var{typed:t,parse:n}=e;return t(Rr,{string:function(e){var t=te();return n(e).compile().evaluate(t)},"string, Map | Object":function(e,t){return n(e).compile().evaluate(t)},"Array | Matrix":function(e){var t=te();return Pn(e,function(e){return n(e).compile().evaluate(t)})},"Array | Matrix, Map | Object":function(e,t){return Pn(e,function(e){return n(e).compile().evaluate(t)})}})}),Br=`size`,Vr=K(Br,[`typed`],e=>{var{typed:t}=e;return t(Br,{Matrix:e=>e.size(),Array:kn,string:e=>[e.length],"number | Complex | BigNumber | Unit | boolean | null":e=>[]})}),Hr=`factorial`,Ur=K(Hr,[`typed`,`gamma`],e=>{var{typed:t,gamma:n}=e;return t(Hr,{number:function(e){if(e<0)throw Error(`Value must be non-negative`);return n(e+1)},BigNumber:function(e){if(e.isNegative())throw Error(`Value must be non-negative`);return n(e.plus(1))},"Array | Matrix":t.referToSelf(e=>t=>Pn(t,e))})}),Wr=`isBounded`,Gr=K(Wr,[`typed`],e=>{var{typed:t}=e;return t(Wr,{number:e=>Number.isFinite(e),"BigNumber | Complex":e=>e.isFinite(),"bigint | Fraction":()=>!0,"null | undefined":()=>!1,Unit:t.referToSelf(e=>t=>e(t.value)),"Array | Matrix":t.referToSelf(e=>t=>(Array.isArray(t)||(t=t.valueOf()),t.every(t=>e(t))))})}),Kr=K(`numeric`,[`number`,`?bignumber`,`?fraction`],e=>{var{number:t,bignumber:n,fraction:r}=e,i={string:!0,number:!0,BigNumber:!0,Fraction:!0},a={number:e=>t(e),BigNumber:n?e=>n(e):Jt,bigint:e=>BigInt(e),Fraction:r?e=>r(e):Yt};return function(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:`number`;if((arguments.length>2?arguments[2]:void 0)!==void 0)throw SyntaxError(`numeric() takes one or two arguments`);var n=Oe(e);if(!(n in i))throw TypeError(`Cannot convert `+e+` of type "`+n+`"; valid input types are `+Object.keys(i).join(`, `));if(!(t in a))throw TypeError(`Cannot convert `+e+` to type "`+t+`"; valid output types are `+Object.keys(a).join(`, `));return t===n?e:a[t](e)}}),qr=Z(`abs`,ct),Jr=Z(`exp`,_t),Yr=Z(`gcd`,yt),Xr=Z(`lcm`,bt),Zr=Z(`log10`,St),Qr=Z(`log2`,Ct),$r=Z(`mod`,Tt),ei=Z(`multiply`,dt),ti=mi(`nthRoot`,Et),ni=Z(`sign`,Dt),ri=Z(`sqrt`,Ot),ii=Z(`subtract`,ut),ai=Z(`pow`,jt),oi=mi(`round`,Mt),si=mi(`log`,xt),ci=Z(`log1p`,wt),li=Z(`add`,lt),ui=Z(`divide`,ft),di=K(`matrix`,[],()=>Xt),fi=K(`subset`,[],()=>Zt);Z(`combinations`,Ft);var pi=Z(`gamma`,Rt);Z(`lgamma`,Ut);function Z(e,t){return K(e,[`typed`],e=>{var{typed:n}=e;return n(t)})}function mi(e,t){return K(e,[`typed`],e=>{var{typed:n}=e;return n({number:t,"number,number":t})})}function hi(e,t,n,r){if(!(this instanceof hi))throw SyntaxError(`Constructor must be called with the new operator`);this.fn=e,this.count=t,this.min=n,this.max=r,this.message=`Wrong number of arguments in function `+e+` (`+t+` provided, `+n+(r==null?``:`-`+r)+` expected)`,this.stack=Error().stack}hi.prototype=Error(),hi.prototype.constructor=Error,hi.prototype.name=`ArgumentsError`,hi.prototype.isArgumentsError=!0;var Q={createTyped:tn},gi={typedDependencies:Q,createAbs:qr},$={createNode:Yn},_i={createSubset:fi},vi={NodeDependencies:$,subsetDependencies:_i,createAccessorNode:$n},yi={typedDependencies:Q,createAdd:li},bi={NodeDependencies:$,createArrayNode:tr},xi={matrixDependencies:{createMatrix:di},NodeDependencies:$,subsetDependencies:_i,createAssignmentNode:ir},Si={gammaDependencies:{typedDependencies:Q,createGamma:pi},typedDependencies:Q,createFactorial:Ur},Ci={typedDependencies:Q,createNumber:qn},wi={typedDependencies:Q,createPow:ai},Ti={NodeDependencies:$,ResultSetDependencies:{createResultSet:sn},createBlockNode:or},Ei={typedDependencies:Q,createRound:oi},Di={NodeDependencies:$,createConditionalNode:cr},Oi={NodeDependencies:$,isBoundedDependencies:{typedDependencies:Q,createIsBounded:Gr},createConstantNode:_r},ki={NodeDependencies:$,typedDependencies:Q,createFunctionAssignmentNode:yr},Ai={NodeDependencies:$,createSymbolNode:Nr},ji={AccessorNodeDependencies:vi,ArrayNodeDependencies:bi,AssignmentNodeDependencies:xi,BlockNodeDependencies:Ti,ConditionalNodeDependencies:Di,ConstantNodeDependencies:Oi,FunctionAssignmentNodeDependencies:ki,FunctionNodeDependencies:{NodeDependencies:$,SymbolNodeDependencies:Ai,createFunctionNode:Fr},IndexNodeDependencies:{NodeDependencies:$,sizeDependencies:{typedDependencies:Q,createSize:Vr},createIndexNode:xr},ObjectNodeDependencies:{NodeDependencies:$,createObjectNode:Cr},OperatorNodeDependencies:{NodeDependencies:$,createOperatorNode:Er},ParenthesisNodeDependencies:{NodeDependencies:$,createParenthesisNode:Or},RangeNodeDependencies:{NodeDependencies:$,createRangeNode:Ar},RelationalNodeDependencies:{NodeDependencies:$,createRelationalNode:Mr},SymbolNodeDependencies:Ai,numericDependencies:{numberDependencies:Ci,createNumeric:Kr},typedDependencies:Q,createParse:Lr},Mi={typedDependencies:Q,createDivide:ui},Ni={typedDependencies:Q,createMultiply:ei},Pi={typedDependencies:Q,createSqrt:ri},Fi={typedDependencies:Q,createSubtract:ii},Ii={createE:Vn},Li={parseDependencies:ji,typedDependencies:Q,createEvaluate:zr},Ri={typedDependencies:Q,createExp:Jr},zi={typedDependencies:Q,createGcd:Yr},Bi={typedDependencies:Q,createLcm:Xr},Vi={typedDependencies:Q,createLog:si},Hi={typedDependencies:Q,createLog10:Zr},Ui={typedDependencies:Q,createLog1p:ci},Wi={typedDependencies:Q,createLog2:Qr},Gi={typedDependencies:Q,createMod:$r},Ki={typedDependencies:Q,createNthRoot:ti},qi={createPi:Bn},Ji={typedDependencies:Q,createSign:ni},Yi=u(c(((e,t)=>{function n(){}n.prototype={on:function(e,t,n){var r=this.e||={};return(r[e]||(r[e]=[])).push({fn:t,ctx:n}),this},once:function(e,t,n){var r=this;function i(){r.off(e,i),t.apply(n,arguments)}return i._=t,this.on(e,i,n)},emit:function(e){for(var t=[].slice.call(arguments,1),n=((this.e||={})[e]||[]).slice(),r=0,i=n.length;r<i;r++)n[r].fn.apply(n[r].ctx,t);return this},off:function(e,t){var n=this.e||={},r=n[e],i=[];if(r&&t)for(var a=0,o=r.length;a<o;a++)r[a].fn!==t&&r[a].fn._!==t&&i.push(r[a]);return i.length?n[e]=i:delete n[e],this}},t.exports=n,t.exports.TinyEmitter=n}))(),1);function Xi(e){var t=new Yi.default;return e.on=t.on.bind(t),e.off=t.off.bind(t),e.once=t.once.bind(t),e.emit=t.emit.bind(t),e}function Zi(e,t,n,r){function i(e,t){var n=arguments.length;if(n!==1&&n!==2)throw new hi(`import`,n,1,2);t||={};function r(e,n,i){if(Array.isArray(n))n.forEach(t=>r(e,t));else if(P(n)||d(n))for(var a in n)H(n,a)&&r(e,n[a],a);else if(Wt(n)||i!==void 0){var o=Wt(n)?h(n)?n.fn+`.transform`:n.fn:i;if(H(e,o)&&e[o]!==n&&!t.silent)throw Error(`Cannot import "`+o+`" twice`);e[o]=n}else if(!t.silent)throw TypeError(`Factory, Object, or Array expected`)}var i={};for(var o in r(i,e),i)if(H(i,o)){var s=i[o];if(Wt(s))l(s,t);else if(u(s))a(o,s,t);else if(!t.silent)throw TypeError(`Factory, Object, or Array expected`)}}function a(t,i,a){if(a.wrap&&typeof i==`function`&&(i=c(i)),f(i)&&(i=e(t,{[i.signature]:i})),e.isTypedFunction(n[t])&&e.isTypedFunction(i)){i=a.override?e(t,i.signatures):e(n[t],i),n[t]=i,delete r[t],o(t,i),n.emit(`import`,t,function(){return i});return}var s=n[t]!==void 0,l=n.Unit?.isValuelessUnit(t);if(!s&&!l||a.override){n[t]=i,delete r[t],o(t,i),n.emit(`import`,t,function(){return i});return}if(!a.silent)throw Error(`Cannot import "`+t+`": already exists`)}function o(e,t){t&&typeof t.transform==`function`?(n.expression.transform[e]=t.transform,p(e)&&(n.expression.mathWithTransform[e]=t.transform)):(delete n.expression.transform[e],p(e)&&(n.expression.mathWithTransform[e]=t))}function s(e){delete n.expression.transform[e],p(e)?n.expression.mathWithTransform[e]=n[e]:delete n.expression.mathWithTransform[e]}function c(e){var t=function(){for(var t=[],r=0,i=arguments.length;r<i;r++){var a=arguments[r];t[r]=a&&a.valueOf()}return e.apply(n,t)};return e.transform&&(t.transform=e.transform),t}function l(t,i){var a=arguments.length>2&&arguments[2]!==void 0?arguments[2]:t.fn;if(a.includes(`.`))throw Error(`Factory name should not contain a nested path. Name: `+JSON.stringify(a));var o=h(t)?n.expression.transform:n,c=a in n.expression.transform,l=H(o,a)?o[a]:void 0,u=function(){var r={};t.dependencies.map(qt).forEach(e=>{if(e.includes(`.`))throw Error(`Factory dependency should not contain a nested path. Name: `+JSON.stringify(e));e===`math`?r.math=n:e===`mathWithTransform`?r.mathWithTransform=n.expression.mathWithTransform:e===`classes`?r.classes=n:r[e]=n[e]});var o=t(r);if(o&&typeof o.transform==`function`)throw Error(`Transforms cannot be attached to factory functions. Please create a separate function for it with export const path = "expression.transform"`);if(l===void 0||i.override)return o;if(e.isTypedFunction(l)&&e.isTypedFunction(o))return e(l,o);if(i.silent)return l;throw Error(`Cannot import "`+a+`": already exists`)},d=t.meta?.formerly??``,f=h(t)||m(t),p=n.expression.mathWithTransform;!t.meta||t.meta.lazy!==!1?(Fe(o,a,u),d&&Fe(o,d,u),l&&c?(s(a),d&&s(d)):f&&(Fe(p,a,()=>o[a]),d&&Fe(p,d,()=>o[a]))):(o[a]=u(),d&&(o[d]=o[a]),l&&c?(s(a),d&&s(d)):f&&(Fe(p,a,()=>o[a]),d&&Fe(p,d,()=>o[a]))),r[a]=t,n.emit(`import`,a,u)}function u(e){return typeof e==`function`||typeof e==`number`||typeof e==`string`||typeof e==`boolean`||e===null||D(e)||T(e)||w(e)||E(e)||A(e)||Array.isArray(e)}function d(e){return typeof e==`object`&&e[Symbol.toStringTag]===`Module`}function f(e){return typeof e==`function`&&typeof e.signature==`string`}function p(e){return!H(g,e)}function m(e){return!e.fn.includes(`.`)&&!H(g,e.fn)&&(!e.meta||!e.meta.isClass)}function h(e){return e!==void 0&&e.meta!==void 0&&e.meta.isTransformFunction===!0||!1}var g={expression:!0,type:!0,docs:!0,error:!0,json:!0,chain:!0};return i}var Qi=u(Qt(),1);function $i(e,t){var n=d({},f,t);if(typeof Object.create!=`function`)throw Error(`ES5 not supported by this JavaScript engine. Please load the es5-shim and es5-sham library for compatibility.`);var r=Xi({isNumber:C,isComplex:T,isBigNumber:w,isBigInt:re,isFraction:E,isUnit:D,isString:O,isArray:k,isMatrix:A,isCollection:j,isDenseMatrix:ie,isSparseMatrix:M,isRange:ae,isIndex:oe,isBoolean:N,isResultSet:se,isHelp:ce,isFunction:le,isDate:ue,isRegExp:de,isObject:P,isMap:F,isPartitionedMap:fe,isObjectWrappingMap:pe,isNull:I,isUndefined:me,isAccessorNode:L,isArrayNode:he,isAssignmentNode:ge,isBlockNode:_e,isConditionalNode:ve,isConstantNode:R,isFunctionAssignmentNode:be,isFunctionNode:xe,isIndexNode:z,isNode:B,isObjectNode:Se,isOperatorNode:Ce,isParenthesisNode:we,isRangeNode:Te,isRelationalNode:Ee,isSymbolNode:V,isChain:De});r.config=ze(n,r.emit),r.expression={transform:{},mathWithTransform:{config:r.config}};var i=[],a=[];function o(e){if(Wt(e))return e(r);var t=e[Object.keys(e)[0]];if(Wt(t))return t(r);if(!Ie(e))throw console.warn("Factory object with properties `type`, `name`, and `factory` expected",e),Error("Factory object with properties `type`, `name`, and `factory` expected");var s=i.indexOf(e),c;return s===-1?(c=e.math===!0?e.factory(r.type,n,o,r.typed,r):e.factory(r.type,n,o,r.typed),i.push(e),a.push(c)):c=a[s],c}var s={};function c(){var e=[...arguments];return r.typed.apply(r.typed,e)}c.isTypedFunction=Qi.default.isTypedFunction;var l=Zi(c,o,r,s);return r.import=l,r.on(`config`,()=>{Object.values(s).forEach(e=>{e&&e.meta&&e.meta.recreateOnConfigChange&&l(e,{override:!0})})}),r.create=$i.bind(null,e),r.factory=K,r.import(Object.values(Ne(e))),r.ArgumentsError=hi,r.DimensionError=On,r.IndexError=Dn,r}const ea=e=>{let n=t(`results`),r=t(`answers`,{assert:!1});if(!r){let e=document.createElement(`h4`);e.setAttribute(`class`,`title`),e.setAttribute(`id`,`answers-title`),e.textContent=`Answers : `,r=document.createElement(`div`),r.setAttribute(`id`,`answers`),r.setAttribute(`role`,`complementary`),r.setAttribute(`aria-labelledby`,`answers-title`),r.appendChild(e)}if(!(e instanceof HTMLElement)){let t=document.createElement(`span`);t.innerHTML=e.toString(),e=t}r.appendChild(e),n.insertAdjacentElement(`afterbegin`,r)};var ta=class n extends e{constructor(){super(`calculator`)}static math=$i({...gi,...yi,...Mi,...Ii,...Li,...Ri,...Si,...zi,...Bi,...Hi,...Ui,...Wi,...Vi,...Gi,...Ni,...Ki,...qi,...wi,...Ei,...Ji,...Pi,...Fi});async run(){let e=t(`q`),r=n.math.parse(e.value);try{return`${r.toString()} = ${r.evaluate()}`}catch{return}}async post(e){ea(e)}};export{ta as default};
//# sourceMappingURL=se1lYYOM.min.js.map