...
CONTAINER_IMAGE_ORGANIZATION=${GITHUB_REPOSITORY_OWNER:-"onlinefinder"}
CONTAINER_IMAGE_NAME="onlinefinder"
...
container.build() {
    ...
    (
        ...
        timestamp_searx_settings=$(git log -1 --format='%ct' ./olf/settings.yml)
