...
data.all() {
    (
        ...
        pyenv.cmd python onlinefinder_extra/update/update_osm_keys_tags.py
        build_msg DATA "update searx/data/ahmia_blacklist.txt"
        python onlinefinder_extra/update/update_ahmia_blacklist.py
        build_msg DATA "update searx/data/wikidata_units.json"
        python onlinefinder_extra/update/update_wikidata_units.py
        build_msg DATA "update searx/data/currencies.json"
        python onlinefinder_extra/update/update_currencies.py
        build_msg DATA "update searx/data/external_bangs.json"
        python onlinefinder_extra/update/update_external_bangs.py
        build_msg DATA "update searx/data/engine_descriptions.json"
        python onlinefinder_extra/update/update_engine_descriptions.py
    )
}
...
data.traits() {
    (
        ...
        python onlinefinder_extra/update/update_engine_traits.py
...
data.useragents() {
    ...
    pyenv.cmd python onlinefinder_extra/update/update_firefox_version.py
    dump_return $?
}
...
data.locales() {
    (
        ...
        python onlinefinder_extra/update/update_locales.py
    )
    dump_return $?
}
